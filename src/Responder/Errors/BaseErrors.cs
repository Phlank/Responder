...
namespace Phlank.Responder
{
    internal static class BaseErrors
    {
        ...
        private static IEnumerable<ApiError> GetDefaultErrors()
        {
        ...
        private static IDictionary<HttpStatusCode, ApiError> StatusCodeToBaseApiErrorDictionary;
        ...
        public static ApiError FromStatusCode(HttpStatusCode statusCode)
        {
            ...
            if (StatusCodeToBaseApiErrorDictionary == null) Setup();
